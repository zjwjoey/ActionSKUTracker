...
品牌字典保存标准名、别名、确认状态和证据。中文品名默认不主动加入品牌名或“牌”
字，品牌另行维护；不得因为品牌已确认就机械拼接品牌。只有当品牌、IP、系列或型号是
识别商品所必需的事实时，才可按人工/可信证据保留其官方写法。技术型号、接口、剂量等
商品事实必须保留；“行李牌”“扑克牌”等商品本体中的“牌”不能误删。品牌未确认时
不得从西语标题臆测，使用通用名并进入审核。此规则只影响中文展示字段，不得改写西语
事实字段。
