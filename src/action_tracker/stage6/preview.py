...
def preview_one(
    ...
    *, policy_hash: str, source_snapshot_path: str | None = None,
    ...
    if candidate is None or source is None or target is None or not source_snapshot_path:
        ...
        expected_source_hash = field_source_hash(source_hash_record, field) if hash_scope == "field" else localization_source_hash(source_hash_record)
    ...
    return {
        ...
        "hash_scope": hash_scope, "current_source_hash": current_source_hash if candidate and source else None,
